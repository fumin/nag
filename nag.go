...
// A FieldSet is a set whose elements make up a field.
type FieldSet[K Field[K]] interface {
...
// A RationalsSet is a set whose elements make up the field of rational numbers.
type RationalsSet struct{}

// NewZero returns the additive identity 0.
func (x RationalsSet) NewZero() *Rat {
	return &Rat{big.NewRat(0, 1)}
}

// NewOne returns the multiplicative identity 1.
func (x RationalsSet) NewOne() *Rat {
	return &Rat{big.NewRat(1, 1)}
}

// Rationals is the field of rational numbers.
var Rationals RationalsSet
...
func NewPolynomial[K Field[K]](field FieldSet[K], order Order, terms ...PolynomialTerm[K]) *Polynomial[K] {
	x := &Polynomial[K]{
...
func (x *Polynomial[K]) Field() FieldSet[K] { return x.field }
