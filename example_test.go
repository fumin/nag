...
func ExamplePolynomial_LeadingTerm() {
	...
	p0 := nag.NewPolynomial(nag.Rationals, nag.Deglex, terms...)
	fmt.Println(p0.LeadingTerm())

	p1 := nag.NewPolynomial(nag.Rationals, nag.ElimOrder(), terms...)
...
func ExampleDivide() {
	...
	fCopy := nag.NewPolynomial(nag.Rationals, nag.Deglex).Set(f)
	...
	ff := nag.NewPolynomial(nag.Rationals, nag.Deglex)
	ff.SymbolStringer = f.SymbolStringer
	cw := nag.NewPolynomial(nag.Rationals, nag.Deglex)
	cwg := nag.NewPolynomial(nag.Rationals, nag.Deglex)
	cwgw := nag.NewPolynomial(nag.Rationals, nag.Deglex)
	for i := range quotient {
		for j := range quotient[i] {
			cij := nag.NewPolynomial(nag.Rationals, nag.Deglex, nag.PolynomialTerm[*nag.Rat]{Coefficient: quotient[i][j].Coefficient})
			wij := nag.NewPolynomial(nag.Rationals, nag.Deglex, nag.PolynomialTerm[*nag.Rat]{Monomial: quotient[i][j].Left})
			wPij := nag.NewPolynomial(nag.Rationals, nag.Deglex, nag.PolynomialTerm[*nag.Rat]{Monomial: quotient[i][j].Right})
